      ...
      if (tagValue !== "") {
        if (tagValue.length > 15) {
          return form.setError("tags", {
            type: "required",
            message: "Tag must be lesser than 15 characters",
          });
        }
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              <FormLabel className="paragraph-semibold text-dark400_light800">
                Quetstion Title <span className="text-primary-500">*</span>
              </FormLabel>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              ...
              <FormDescription className="body-regular mt-2.5 text-light-500">
                Add up to three tags to describe what you&apos;re question is
